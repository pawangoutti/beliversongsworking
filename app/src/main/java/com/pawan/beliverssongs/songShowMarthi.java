...
public class songShowMarthi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_song_show_marthi);
        recview=(RecyclerView)findViewById(R.id.recviewm);
        recview.setLayoutManager(new LinearLayoutManager(this));
        Toast.makeText(songShowMarthi.this, "Loading Songs Please Wait...", Toast.LENGTH_LONG).show();
